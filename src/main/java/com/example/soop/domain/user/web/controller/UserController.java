...
public class UserController {
    ...
    public ApiResponse<UserResponseDTO.SignUpResponseDTO> signUp(@RequestBody @Valid UserRequestDTO.SignUpRequestDTO request) {
    ...
    public ApiResponse<UserResponseDTO.SignInResponseDTO> signIn(@RequestBody @Valid UserRequestDTO.SignInRequestDTO request) {
